						...
						<div class="col-md-12">
							<div class="card">
								<table class="table table-hover" style="text-align: center">
			                            ...
			                            <tbody>
			                            	...
			                            	<c:forEach var="sl" items="${sellList}">
				                                <tr>
				                                	<td>
				                                		${index = index+1}
				                                	</td>
				                                    ...
				                                    <td>
				                                    	<h5 style="color:blue">${sl.price}</h5>
				                                    </td>
				                                    <td>
				                                    	<h5 style="color:red">${sl.commissions}</h5>
				                                    </td>
				                                    <td>
				                                    	<h5>${sl.createDate}</h5>
				                                    </td>
							...
							<div class="card-footer">
								<c:if test="${currentPage>1}">
									<a href="${pageContext.request.contextPath}/users/sellList?currentPage=${currentPage-1}">
