        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">매니저 정보 수정</h1>
                    <p class="mb-4">수정을 완료하시려면 <strong>수정완료</strong> 버턴을 클릭하세요.<br>
                    <small>※ 레벨이 0인 매니저는 퇴사한 매니저입니다.<br>★ 레벨1 : 신규 매니저 | ★ 레벨2 : 선임 매니저 | ★ <strong>레벨9</strong> : 최고 관리자 매니저</small></p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary"><strong>${managerInfo.managerName}님의 정보 수정하기</strong></h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form id="modifyForm" action="${pageContext.request.contextPath}/manager/modifyManager" method="post">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
											<tbody>
												<tr>
													<td>아이디 :</td>
													<td><input type="hidden" id="managerId"
														name="managerId" value="${modifyManagerOne.managerId}">
														${modifyManagerOne.managerId}</td>
												</tr>
												<tr>
													<td>이름 :</td>
												...
												<tr>
													<td>레벨 :</td>
													<td><select name="managerLevel" id="managerLevel"
														class="form-control">
