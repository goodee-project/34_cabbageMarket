        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">상세 정보를 원하시면 회원 <strong>아이디</strong>를 클릭하세요.<br>
                    <small>※ 회원 ID와 닉네임 앞에 N:이 있으면 네이버 연동된 회원입니다.</small></p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">배추마켓 매니저 목록</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
								<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
							        ...
							        <c:if test="${currentPage > 1}">
							            <li class="previous"><a href="${pageContext.request.contextPath}/manager/getAllUsersByManager?currentPage=${currentPage-1}&searchWord=${searchWord}">&lt; PREV</a></li>
							        </c:if>
							        <c:if test="${currentPage < lastPage}">
							            <li class="next"><a href="${pageContext.request.contextPath}/manager/getAllUsersByManager?currentPage=${currentPage+1}&searchWord=${searchWord}">NEXT &gt;</a></li>
							        </c:if>
							    </ul>
								...
								<!-- 검색 박스.. -->
								<form action="${pageContext.request.contextPath}/manager/getAllUsersByManager" method="get"
