...
<head>
    ...
    <title>배추마켓 - 판매완료 중고상품 운송장 번호 입력 및 상태 수정</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">판매완료 중고상품 운송장 번호 입력 및 상태 수정</h1>
                    <p class="mb-4">수정을 완료하시려면 <strong>수정완료</strong> 버턴을 클릭하세요.<br>
                    <small>※ 정확한 운송장 번호 입력 부탁드립니다.<br>★ 본 상품이 맞는지 꼭, 꼭 확인하세요 !!</small></p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="modifyForm" action="${pageContext.request.contextPath}/manager/modifySoldoutUsedProduct" method="post">
											...
											<tbody>
												...
												<tr>
													...
													<td><input type="text" id="waybillNumber"
														name="waybillNumber"
														value="${soldoutProductOne.waybillNumber}" class="form-control"></td>
												</tr>
												<tr>
													<td>배송 요청사항 :</td>
													<td>${soldoutProductOne.deliveryRequest}</td>
												</tr>
												<tr>
													<td>배송 상태 :</td>
												...
												<tr>
													<td>판매된 날짜 :</td>
													<td>${soldoutProductOne.createDate}</td>
												</tr>
											</tbody>
										</table>
