				...
				<div class="row">
	                ...
	                <div class="col-lg-9" style="display: inline;">
	                	<label for="imgFileUpload">
					        <c:forEach var="img" items="${imgNameList}">
                        		<img class="images" data-imgbigurl="${pageContext.request.contextPath}/template/img/directTradeImg/${img}"
	                ...
	                <div class="col-lg-9 checkout__input">
		                ...
		                <div class="col-lg-9">
		                	...
		                	<span id="selectCategorySub" style="font-weight:bold;">${productDetail.categorySubName}</span>
		                	</span>
		                </div>
	                </div>
	                ...
	                <div class="col-lg-9 checkout__input" style="display: inline;">
	                	<input type="text" id="productPrice" name="productPrice" value="${productDetail.productPrice}" style="width: 90%">&nbsp;원
	                </div>
	                <div class="col-lg-12" style="margin-bottom: 15px;"><hr style="border: solid 1px lightgrey;"></div>	
	                ...
	                <div class="col-lg-9 checkout__input" style="display: inline;">
	                	<textarea id="productDesc" name="productDesc" rows="10" cols="30">${productDetail.productDesc}</textarea>
	                </div>
	                <div class="col-lg-12" style="margin-bottom: 15px;"><hr style="border: solid 1px lightgrey;"></div>				
	                ...
	                <div class="col-lg-9 checkout__input" style="display: inline;">
	                <div></div>
	                	<input type="text" id="sample5_address" name="location" value="${productDetail.location}" readonly="readonly" style="display:inline-block; width: 75%">
