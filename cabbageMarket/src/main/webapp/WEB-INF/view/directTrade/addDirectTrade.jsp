    ...
    <script> 
    	function setThumbnail(event){ 
    		...
    		for (var image of event.target.files) {
    			...
    			$('#target').prepend('<input id="imgFileUpload" name="directTradeProductImgs" type="file" style="display: none;" accept="image/*" onchange="setThumbnail(event);" multiple="multiple"/>');
    		} 
    	} 
    </script>
