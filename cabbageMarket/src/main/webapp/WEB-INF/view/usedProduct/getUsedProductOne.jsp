			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<div class="breadcrumb__text">
						<h2>UsedProduct Details</h2>
						<div class="breadcrumb__option">
							<a href="${pageContext.request.contextPath}/index">Home</a> <a
								href="${pageContext.request.contextPath}/users/getAuctionList">UsedProduct
								Details</a> <span>Cabbage Market</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
					...
					<div class="product__details__pic">
						<div class="product__details__pic__item">
							<img class="product__details__pic__item--large"
								src="${pageContext.request.contextPath}/template/img/applyProductImg/${imgPathList[0]}"
								alt="">
						</div>
						<div class="product__details__pic__slider owl-carousel">
							<c:forEach var="img" items="${imgPathList}">
								<img
									data-imgbigurl="${pageContext.request.contextPath}/template/img/applyProductImg/${img}"
				...
				<div class="col-lg-6 col-md-6">
					<div class="product__details__text">
						...
						<div class="product__details__price">${UsedProductDetail.productPrice}</div>
						<p>${UsedProductDetail.productDesc}</p>
						<a href="#" class="primary-btn" style="margin-top: 3px;">판매중</a>
						<div class="heart-btn">
							<div class="content">
						...
						<ul>
							...
							<li><b>판매 가격</b> <span>${UsedProductDetail.productPrice}</span></li>
							<li><b>마감 기한</b> <span>${UsedProductDetail.deadLine}</span></li>
							<li><b>Share on</b>
								<div class="share">
