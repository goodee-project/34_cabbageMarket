                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <a href="${pageContext.request.contextPath}/users/getUsedProductList">UsedProduct List</a>
			...
			<form id="addUsedProductForm" action="${pageContext.request.contextPath}/users/addUsedProduct" method="post">
				...
				<div class="row">
	                ...
	                <div class="col-lg-9 checkout__input" style="display: inline;">
	                	<textarea id="productDesc" name="productDesc" rows="10" cols="30" placeholder="상품 설명을 입력하세요."></textarea>
	                </div>
