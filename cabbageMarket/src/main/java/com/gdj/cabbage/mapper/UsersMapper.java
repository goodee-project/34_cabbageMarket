...
public interface UsersMapper {
	...
	int deleteAddress(ShippingAddress shippingAddress);
	...
	int deleteAuctionProduct(int applyProductSalesDeliveryId);
	...
	Map<String, Object> getBoughtProductOne(int applyId);
	Map<String, Object> getBiddingProductOne(int apllyId);
} 
